      ...
      <Container className="space-y-6">
        <Section title="Provisioning" description="Create artists, labels, and manage links between entities.">
          <div className="space-y-4">
            ...
            <div className={formClass}>
              <p className="text-sm font-black uppercase tracking-widest text-slate-900 dark:text-white">Link artist ↔ user</p>
              <input
            ...
            <div className={formClass}>
              <p className="text-sm font-black uppercase tracking-widest text-slate-900 dark:text-white">Link label ↔ artist</p>
              <input

...
import { LISTING_PHOTO_ACCEPT, MAX_LISTING_PHOTOS, type FieldErrors } from '../../pages/AdminProductsPage.utils';
...
type Props = {
  ...
  onSetEditActive: (value: boolean) => void;
};
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <label className="block space-y-2 md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      onMarkInteraction();
                      onSetEditDescription(e.target.value);
                    }}
                    rows={4}
                  ...
                  <label className="relative flex cursor-pointer items-center gap-3">
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => {
                          onMarkInteraction();
                          onSetEditActive(e.target.checked);
                        }}

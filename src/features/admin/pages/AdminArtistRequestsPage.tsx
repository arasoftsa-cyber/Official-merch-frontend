                    ...
                    <section>
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm font-bold text-slate-900 dark:text-white">{reviewRequest.artistName || 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â'}</span>
                        </div>
                        <div className="flex flex-col">
                          <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase">Handle</span>
                          <span className="text-sm font-mono text-indigo-600 dark:text-emerald-400">@{reviewRequest.handle || 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â'}</span>
                        </div>
                        <div className="flex flex-col">
                          <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase">Email</span>
                          <span className="text-sm font-medium text-slate-900 dark:text-white">{reviewRequest.email || 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â'}</span>
                        </div>
                        <div className="flex flex-col">
                          <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase">Phone</span>
                          <span className="text-sm font-medium text-slate-900 dark:text-white">{reviewRequest.phone || 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â'}</span>
                        </div>
                        <div className="flex flex-col">

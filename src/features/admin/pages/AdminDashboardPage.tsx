    ...
    <DashboardShell title="Admin Dashboard" subtitle="Read-only metrics for orders, buyers, and GMV.">
      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <Link
          ...
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="ARTISTS" value={UNAVAILABLE_VALUE} hint="Onboarded artists" />
        </Link>
        <Link
          to="/partner/admin/products"
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="PRODUCTS" value={UNAVAILABLE_VALUE} hint="Manage catalog & variants" />
        </Link>
        <Link
          to="/partner/admin/inventory-skus"
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="SKU MASTER" value={UNAVAILABLE_VALUE} hint="Central supplier SKU control" />
        </Link>
        <Link
          to="/partner/admin/drops"
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="DROPS" value={UNAVAILABLE_VALUE} hint="Manage drop campaigns" />
        </Link>
        <Link
          to="/partner/admin/homepage-banners"
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="HOMEPAGE" value={UNAVAILABLE_VALUE} hint="Manage hero banners" />
        </Link>
        <Link
          to="/admin/provisioning"
          className="text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 dark:focus-visible:ring-white/60 hover:border-slate-200 dark:hover:border-white/20 hover:bg-slate-50 dark:hover:bg-white/10 cursor-pointer rounded-2xl transition"
        >
          <KpiCard label="PROVISIONING" value={UNAVAILABLE_VALUE} hint="Create artists/labels & links" />
        </Link>

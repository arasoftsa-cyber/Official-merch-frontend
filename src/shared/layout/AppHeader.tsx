          ...
          <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-3">
            ...
            {showMyAccount ? (
              <>
                ...
                <Link
                  to="/fan"
                  className="inline-flex w-fit rounded-md border border-slate-300 dark:border-white/25 px-3 py-1.5 text-sm text-slate-700 hover:bg-slate-100 dark:text-white dark:hover:bg-white/10"
                >
                  My Account
                </Link>
              </>
